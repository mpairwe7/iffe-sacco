            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
              <div>
                ...
                <div className="flex flex-wrap gap-4 mt-10">
                  ...
                  <ShareButton variant="glass" label="Share SACCO" className="px-6 py-4 text-base" />
                </div>
        ...
        <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10 relative z-10">
          <div className="grid md:grid-cols-3 gap-12 lg:gap-20 pb-12 border-b border-gray-800">
            <div>
              <div className="flex items-center gap-3.5 mb-5">
                ...
                <div className="leading-tight">
                  <span className="text-2xl font-extrabold">
                    <span className="text-emerald-400 font-black">IFFE</span>{" "}
              ...
              <p className="text-xs text-gray-400 mt-3">P.O. Box 111223, Jinja, Uganda</p>
            </div>
            <div>
              <h3 className="text-sm font-bold uppercase tracking-wider text-gray-300 mb-6">Quick Links</h3>
            ...
            <div>
              <h3 className="text-sm font-bold uppercase tracking-wider text-gray-300 mb-6">Contact Us</h3>
              <ul className="space-y-4">
                <li className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-full bg-primary/20 ring-1 ring-primary/30 flex items-center justify-center">
