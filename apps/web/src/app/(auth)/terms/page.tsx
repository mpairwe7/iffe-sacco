  ...
  return (
    <div className="glass-card rounded-xl p-8 shadow-xl max-h-[70vh] overflow-y-auto">
      ...
      <div className="prose prose-sm text-text-muted space-y-4">
        ...
        <p>
          You must provide accurate and complete information during registration. You are responsible for maintaining
        ...
        <p>
          We are committed to protecting your personal and financial data in accordance with applicable data protection
          regulations. See our Privacy Policy for details.
        </p>
        ...
        <p>
          These terms are governed by the laws of the Republic of Kenya and applicable cooperative society regulations.
        </p>
      </div>
    </div>
  );
