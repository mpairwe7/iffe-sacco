  ...
  return (
    <div className="glass-card rounded-xl p-8 shadow-xl max-h-[70vh] overflow-y-auto">
      ...
      <div className="prose prose-sm text-text-muted space-y-4">
        ...
        <p>
          We collect personal information including name, email, phone number, national ID, and financial transaction
          data necessary to provide our SACCO services.
        </p>
        <h3 className="text-base font-semibold text-text">2. How We Use Your Data</h3>
        <p>
          Your data is used to manage your account, process transactions, calculate interest, facilitate loans, and
          communicate important account updates.
        </p>
        <h3 className="text-base font-semibold text-text">3. Data Security</h3>
        <p>
          We employ 256-bit SSL encryption, secure data storage, and regular security audits to protect your
        ...
        <p>
          We do not sell your personal data. We may share data with regulatory authorities as required by law, and with
          service providers who assist in platform operations.
        </p>
        <h3 className="text-base font-semibold text-text">5. Your Rights</h3>
        <p>
          You have the right to access, correct, and request deletion of your personal data. Contact us at
          privacy@iffeds.org for data-related requests.
        </p>
