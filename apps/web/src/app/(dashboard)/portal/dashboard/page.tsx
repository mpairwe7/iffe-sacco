...
export default function MemberHomeDashboardPage() {
    ...
    return (
      <div className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 shadow-sm rounded-xl p-12 text-center">
        <p className="text-text-muted">
          {error instanceof Error ? error.message : "Your member dashboard could not be loaded."}
        </p>
  ...
  return <MemberDashboardView dashboard={data} variant="member" />;
}
